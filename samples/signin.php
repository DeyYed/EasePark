...
<div class="container">
  <div class="word-container">
    <p class="p-title">Cyber Park</p>
    <div class="saying-container">
      <span class="span-saying">The Future of Parking is Here. Park Smarter, Not Harder.</span>
    </div>
  </div>
  <form class="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
    ...
    <a class="changepassword" href="verifychangepassword.php">Change Password</a>
  </form>
