    ...
    <div class="rfid-account-table">
      <div class="header-table">
        ...
        <div class="search-container">
          <a href="data.php"><button class="back-button js-search-button">Back</button></a>
...
<script>
  ...
  function deleteUIDFile() {
    fetch('../admin/rfid/delete_uid.php')
  ...
  function save(data) {
    ...
    // Update the table cell contents if needed
    ...
    fetch('save_data.php', {
        ...
        body: `user_id=${data}&fname=${encodeURIComponent(newFname)}&lname=${encodeURIComponent(newLname)}&uid=${encodeURIComponent(newUid)}`
      })
      .then(response => response.text())
      .catch(error => {
  ...
  if (
    ...
    if (isset($_POST['registersubmit'])) {
      ...
      if ($existingCode) {
        ...
        $message = "This is your verification code for the link below<br>Verification Code: " . $verificationCode . "<br>Link: https://easepark.online/register.php" . "<br>UID: " . $uid;
    ...
    echo "Invalid form submission or possible CSRF attack.";
  }
} else {
